...
public class ACSCensusDataSource implements CensusDataSource {
  ...
  public List<String> getBroadbandPercentage(String countyname, String statename) throws InputNotFoundException, DataSourceException {
    ...
    try {
      ...
      return_list.add(countyname);
      return_list.add(statename);
      return_list.add(broadband_percentage);
      return_list.add(datetime.toString());
      return return_list;
    } catch (IOException e) {
      throw new DataSourceException(e.getMessage());
    }
